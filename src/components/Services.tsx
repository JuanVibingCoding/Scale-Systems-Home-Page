      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 md:px-12">
        ...
        <div className="grid lg:grid-cols-3 gap-6 sm:gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="group relative bg-scale-card border border-scale-border rounded-3xl p-8 sm:p-10 overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(3,250,110,0.1)]"
            >
              {/* Hover Glow */}
              ...
              <div className="relative z-10">
                ...
                <p className="text-scale-muted leading-relaxed">
                  {service.details}
                </p>
              </div>
            </div>
